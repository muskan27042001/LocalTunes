...
class MusicService: Service(), AudioManager.OnAudioFocusChangeListener {
    ...
    // Runnable helps us to execute same code again and again
    ...
    // inner class helps us to return object of main class
    ...
    fun showNotification(playPauseBtn: Int){
        ...
        // getting image of current song for notification
    ...
    fun seekBarSetup(){
        // text and progress of seekbar should be set again and again after 200 milli seconds
        runnable = Runnable {
            PlayerActivity.binding.tvSeekBarStart.text = formatDuration(mediaPlayer!!.currentPosition.toLong())
            PlayerActivity.binding.seekBarPA.progress = mediaPlayer!!.currentPosition
            Handler(Looper.getMainLooper()).postDelayed(runnable, 200)
        }
        // in starting after 0 milli seconds this runnable code should start(means it should start immediately
        // ie 0 milli seconds)
